                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper nature">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-details">
                            	...
                            	<div class="editContent">
                                	<p>Este sistema permite realizar la gestión de la correspondencia interna de la Subcontraloria de Empresas Públicas</p>
                            	</div>
                            </div>
                        </div>
                    </div> 
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper nature">
                <div class="gallery-item">
                    ...
                    <div class="gallery-details">
                        ...
                        <div class="editContent">
                            <p>Permite realizar la gestión de la Informacion relacionada al CONTROL INTERNO en la administración de empresas públicas de la Subcontraloria de Empresas Públicas</p>
                        </div>
                    </div>
                </div>
            </div>  
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper nature">
                <div class="gallery-item">
                    ...
                    <div class="gallery-details">
                        ...
                        <div class="editContent">
                            <p>Permite realizar la gestión de la Informacion relacionada al CONTROL INTERNO en la administración de Empresas Públicas</p>
                        </div>
                    </div>
                </div>
            </div>  
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper nature">
                <div class="gallery-item">
                    ...
                    <div class="gallery-details">
                        ...
                        <div class="editContent">
                            <p>Permite realizar la gestión de la Informacion relacionada al Control Externo Posterior realizado a las Empresas PúblicaS</p>
                        </div>
                    </div>
                </div>
            </div>  
        ...
        <!--- CONTROL EXTERNO POSTERIOR -->
            <div class="col-md-4 col-sm-6 col-xs-12 gallery-item-wrapper nature">
                <div class="gallery-item">
                    ...
                    <div class="gallery-details">
                        <div class="editContent">
                            <h5>CONTRATACIONES DE EMPRESAS PÚBLICAS</h5>
                        </div>
                        <div class="editContent">
