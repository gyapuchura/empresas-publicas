...
<html>
	<head>
		...
		<title>Confiabilidad UAI por Empresa</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'EVALUACIONES DE INFORMES DE CONFIABILIDAD'
        },
        subtitle: {
...
?>
        ...
        tooltip: {
            valueSuffix: ' CONFIABILIDAD DE EEFF'
        },
        plotOptions: {
            bar: {
                dataLabels: {
...
<a href="detalle_empresa_uai.php?idempresa=<?php echo $row[0];?>&gestion=2021&idtipo_hojaruta=<?php echo $idtipo_hojaruta;?>" target="_blank" class="Estilo12" onClick="window.open(this.href, this.target, 'width=800,height=400,scrollbars=YES,top=50,left=200'); return false;"><?php echo $sexta;?></a> 
