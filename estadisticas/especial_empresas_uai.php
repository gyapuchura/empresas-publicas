...
<html>
	<head>
		...
		<title>AUDITORIA ESPECIAL POR EMPRESA</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'AUDITORÍAS ESPECIALES UAIs'
        },
        subtitle: {
...
while ($field2 = mysqli_fetch_field($result2)){
	...
	?>
 {
            ...
            data: [
                ...
                <?php 
$numero3 = 0;
$sql3 = " SELECT uai_trabajo.idempresa, empresa.sigla FROM uai_trabajo, empresa WHERE uai_trabajo.idempresa=empresa.idempresa AND uai_trabajo.idtipo_hojaruta='$idtipo_hojaruta' AND empresa.vigente='VIGENTE' GROUP BY uai_trabajo.idempresa ORDER BY empresa.sigla";
...
<div id="container" style="min-width: 310px; max-width: 850px; height: 1000px; margin: 0 auto"></div>
