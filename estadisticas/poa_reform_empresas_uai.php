...
<html>
	<head>
		...
		<title>INFORMES DE EVALUACIÓN POA - UAIS</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'INFORMES DE EVALUACIÓN POA REFORMULADO - UAIs'
        },
        subtitle: {
...
<div id="container" style="min-width: 310px; max-width: 850px; height: 500px; margin: 0 auto"></div>
