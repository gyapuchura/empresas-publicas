...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">REGISTRO INFORME DJBR - UAI</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
        ...
        <h4 align="center"><a href="eval_djbr_uai.php">VOLVER</a></h4>
    </div>
</br>
...
<!-- javascript --->
<form name="FORM9" action="guarda_djbr_uai.php" method="post" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">REGISTRO NUEVO SEGUIMIENTO</h5>
