...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">REGISTRO INFORME POA - UAI</h2>
			</div>
		</div>
	</div>
	</section>
...
<!-- javascript --->
<form name="FORM9" action="guarda_poa_uai.php" method="post" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">REGISTRO NUEVA EVLAUACION POA - UAI</h5>
