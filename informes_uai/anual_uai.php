...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">INFORMES ANUALES - UAI</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
      ...
      <h3 align="center"> </h3>
       <p>EN ESTA SECCIÓN SE ENCUENTRAN LOS REGISTROS DE INFORMES ANUALES EVALUADOS A LAS UAIs</p>
    </div>
    </div>
    <div class="row">
    <div class="col-md-4">
        <form name="FORMU" action="nuevo_anual_uai.php" method="post">
        <button type="submit" class="btn btn-primary">NUEVO REGISTRO</button>
        </form>
    </div>
    <div class="col-md-4"></div>
    <div class="col-md-4">
    <h4><a href="../estadisticas/anuales_uai.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1000,height=700,scrollbars=YES'); return false;">
    GRÁFICO INFORMES ANUALES UAIS-EMPRESAS</a></h4>
    </div>
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            $sql.=" AND uai_trabajo.idtipo_hojaruta=tipo_hojaruta.idtipo_hojaruta AND uai_trabajo.idtipo_hojaruta='7' ORDER BY uai_trabajo.iduai_trabajo ";
        ...
        <!-- Modal ver el archivo -->
            ...
            <td>
                <form name="VALIDA" action="valida_anual_uai.php" method="post">
