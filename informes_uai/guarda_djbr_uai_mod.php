...
if ($codigo =='' || $gestion =='' || $idempresa =='' || $tipo_informe =='') {
    ...
    header("Location:mostrar_djbr_uai.php");
        ...
        if ($file_name != '' || $file_name != null) {
                ...
                if (move_uploaded_file($_FILES['file']['tmp_name'],'../'.$subir_archivo)) {
                    ...
                    $ins = $link->query(" UPDATE uai_trabajo SET codigo='$codigo', gestion='$gestion', idempresa='$idempresa', tipo_informe='$tipo_informe', idtipo_hojaruta='30', elaborador='$elaborador_u', idusuario='$idusuario_ss', url='$subir_archivo' WHERE iduai_trabajo='$iduai_trabajo_ss' "); 
            ...
            {
                $actualiza = $link->query("UPDATE uai_trabajo SET codigo='$codigo', gestion='$gestion', idempresa='$idempresa', tipo_informe='$tipo_informe', idtipo_hojaruta='30', elaborador='$elaborador_u', idusuario='$idusuario_ss' WHERE iduai_trabajo='$iduai_trabajo_ss' "); 
