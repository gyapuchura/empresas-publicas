...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">EVALUACIÓN POA REFORMULADO - UAI</h2>
			</div>
		</div>
	</div>
	</section>
    ...
    <div class="row">
    <div class="col-md-6"><h4><a href="../estadisticas/poa_reform_empresas_uai.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1000,height=700,scrollbars=YES'); return false;">
    GRÁFICO INFORMES POA UAIS-EMPRESAS</a></h4></div>
    <div class="col-md-6">   
    </div>   
    </div>
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            $sql.=" AND uai_trabajo.idtipo_hojaruta=tipo_hojaruta.idtipo_hojaruta AND uai_trabajo.idtipo_hojaruta='9' ORDER BY uai_trabajo.iduai_trabajo ";
        ...
        <!-- Modal ver el archivo -->
            ...
            <td>
                <form name="VALIDAPOA" action="valida_poa_reform_uai.php" method="post">
