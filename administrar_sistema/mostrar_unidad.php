...
<!-- javascript --->
<form name="FORM9" action="guarda_mod_unidad.php" method="post">

<div class="box-area">

<div class="row">
  <div class="col-md-2"><h4>DENOMINACIÓN:</h4></div>
  <div class="col-md-4"><textarea class="form-control" rows="3" name="direccion" required><?php echo $row_u[1];?></textarea></div> 
  <div class="col-md-1"><h4>SIGLA:</h4></div>
  <div class="col-md-2"><input type="text" class="form-control" name="sigla" value="<?php echo $row_u[2];?>" required></div>  
  <div class="col-md-1"><h4>ESTADO:</h4></div>
  <div class="col-md-2">
  <select name="vigente"  id="vigente" class="form-control" required>
...
?>
<option value="<?php echo $rowv[1];?>" <?php if ($rowv[1]==$row_u[3]) echo "selected";?> ><?php echo $rowv[1];?></option>
<?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ¿Esta seguro de guardar lo cambios de la UNIDAD?
       </div>
