...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">NUEVA UNIDAD ORGANIZACIONAL</h2>
			</div>
		</div>
	</div>
	</section>
    ...
    <h3><?php echo $rowh[1];?> - <?php echo $rowh[2];?></h3>   
...
<!-- javascript --->
<form name="FORM9" action="guarda_area.php" method="post">

<div class="box-area">

<div class="row">
  <div class="col-md-3"><h4>DENOMINACIÓN DEL ÁREA:</h4></div>
  <div class="col-md-5"><textarea class="form-control" rows="3" name="area" required></textarea></div> 
