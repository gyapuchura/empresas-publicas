...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">NUEVO CARGO</h2>
			</div>
		</div>
	</div>
	</section>
    ...
    <h4 align="center"><a href="areas.php">VOLVER A CARGOS</a></h4>
  </div>
</br>
...
<!-- javascript --->
<form name="FORM9" action="guarda_cargo.php" method="post">

<div class="box-area">

<div class="row">
  <div class="col-md-3"><h4>DENOMINACIÓN DEL CARGO:</h4></div>
  <div class="col-md-5"><textarea class="form-control" rows="3" name="cargo" required></textarea></div> 
  <div class="col-md-1"><h4>N° DE ITEM:</h4></div>
  <div class="col-md-3"><input type="text" class="form-control" name="item" required></div>  
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">REGISTRO NUEVO CARGO</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ¿Esta seguro de Registrar el NUEVO CARGO?
       </div>
