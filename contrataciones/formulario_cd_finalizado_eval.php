...
<div class="row">
<div class="col-md-12"><h3>FINALIZACIÓN DE EVALUACIÓN F-3009</h3></div>
</div>
<div class="row"> 
<div class="col-md-12"><h3 class="text-muted">ACABA DE FINALIZAR LA EVALUACIÓN DEL FORMULARIO <?php echo $codigo_form_ss;?>.</h3></div>
</div>

<div class="row">
<div class="col-md-4"><h3>
<form name="EVENTO" action="formularios_asignados.php" method="post">
<button type="submit" class="btn btn-primary">VOLVER A FORMULARIOS ASIGNADOS</button></form>
</h3></div>
<div class="col-md-4"></div>
<div class="col-md-4">
<h3>
<form name="EVENTO" action="nuevo_formulario_cd.php" method="post">
<button type="submit" class="btn btn-primary">ELABORAR INFORME DE EVALUACION</button></form>
</h3>
</div>
</div>
