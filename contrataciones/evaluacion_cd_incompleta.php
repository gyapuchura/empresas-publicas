...
<?php
    ...
    $sql4.=" WHERE registro_cd.idpunto_cd=punto_cd.idpunto_cd AND registro_cd.idformulario_cd='$idformulario_cd_ss' AND estado_eval='REGISTRADO' ";
...
<?php  echo "NO SE HA EVALUADO EL PUNTO ".$row4[1]; ?>    
</h4></div>
</div>
...
<form name="VOLVER" action="evalua_puntos_cd.php" method="post">	  
