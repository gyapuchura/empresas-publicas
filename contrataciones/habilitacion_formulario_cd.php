...
<script language="javascript" src="../js/jquery-3.1.1.min.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">HABILITACIÓN DE FORMULARIOS F-3009</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
      ...
      <h3>PARA HABILITAR CORRECCIÓN DE FORMULARIOS FINALIZADOS</h3>
    </div>
    </div>
      ...
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
          ...
          <?php
            ...
            ?>
                ...
                <td>  
                    <form name="HABILITA" action="guarda_habilitacion_cd.php" method="post">
                    <input name="idformulario_cd" type="hidden" value="<?php echo $row[0];?>">                    
                    <button type="submit" class="btn btn-primary">HABILITAR F-3009</button>            
                    </form>  
                </td>
                </tr>  
            <?php
...
<script src="../s/dataTables.bootstrap.min.js"></script>
</body>
</html>