...
<?php   
    $sql4 =" SELECT registro_cd.idregistro_cd, punto_cd.indice, punto_cd.punto_cd, cumplimiento.cumplimiento, verificacion_cd.verificacion_cd, registro_cd.comentario_verif_cd FROM registro_cd, punto_cd, cumplimiento, verificacion_cd ";
    $sql4.=" WHERE registro_cd.idverificacion_cd=verificacion_cd.idverificacion_cd AND registro_cd.idpunto_cd=punto_cd.idpunto_cd AND registro_cd.idcumplimiento=cumplimiento.idcumplimiento AND registro_cd.idformulario_cd='$idformulario_cd_ss' ";
...
<div class="row">
  <div class="col-md-4"><h5>VERIFICACIÓN:</h5> <h4 <?php if ($row4[4] != '0') { echo 'class="text-success"';} else { echo 'class="text-danger"'; }?>><?php echo $row4[4];?> </h4></div>
  <div class="col-md-8"><h5>COMENTARIO/ANÁLISIS:</h5> <h4 <?php if ($row4[4] != '') { echo 'class="text-success"';} else { echo 'class="text-danger"'; }?>><?php echo $row4[5];?> </h4></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">CONCLUIR EVALUACIÓN DE F-3009</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ¿Esta seguro de CONCLUIR LA EVALUACIÓN DEL FORMULARIO F-3009?
