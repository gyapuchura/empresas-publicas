...
<script language="javascript" src="../js/jquery-3.1.1.min.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">ASIGNACIÓN DE FORMULARIOS F-3009</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
      ...
      <h3>FORMULARIOS F - 3009 POR ASIGNAR A SUPERVISORES DE LA SCEP</h3>
    </div>
    </div>
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
          ...
          <?php
            ...
            $sql.=" empresa.sigla FROM formulario_cd, empresa WHERE formulario_cd.idempresa=empresa.idempresa AND formulario_cd.estado='FINALIZADO' AND formulario_cd.supervisor='0' ";
            ...
            ?>
                ...
                <td>
            <form name="ASIGNA_FORM" action="guarda_asignacion_cd.php" method="post">
            ...
            $sql4.= " AND usuarios.idcargo=cargo.idcargo AND usuarios.condicion='ACTIVO' AND usuarios.idarea='12' ";
            $result4 = mysqli_query($link,$sql4);
            if ($row4 = mysqli_fetch_array($result4)){
            mysqli_field_seek($result4,0);
            while ($field4 = mysqli_fetch_field($result4)){
            } do {
            echo "<option value=". $row4[0]. ">".$row4[4]." ".$row4[1]." ".$row4[2]." ".$row4[3]."</option>";
