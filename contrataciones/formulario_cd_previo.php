...
<div class="col-md-4"><h2 align="center"><a href="formulario_cd_elab.php">VOLVER</a></h2></div>
<div class="col-md-4"></div> 
</div>
...
<div class="row"> 
<div class="col-md-12"><h3>II. ACTIVIDADES PREVIAS</h3></div>
</div>
...
<?php   
    ...
    $sql4.=" WHERE registro_cd.idpunto_cd=punto_cd.idpunto_cd AND registro_cd.idformulario_cd='$idformulario_cd_ss' AND registro_cd.idetapa_cd='1' ";
...
?>
 ...
 <div class="box-area">
 <div class="row">
  <div class="col-md-8"><h4 <?php if ($row4[3] == '1' || $row4[3] == '2') { echo 'class="text-success"';} else { echo 'class="text-danger"'; }?>><?php echo $row4[1];?> <?php echo $row4[2];?></h4></div>
  <div class="col-md-2">
  <form name="FORM-3009" action="guardar_cd_reg.php" method="post">
...
<div class="row">
  ...
  <form name="FORM-3009" action="guardar_cd_subreg.php" method="post">
  ...
  <div class="col-md-3"><textarea class="form-control" rows="3" name="justificacion" placeholder="Justificación Normativa" <?php if ($row4[3] != '0') { } else { echo "disabled"; }?> required><?php echo $row5[5];?></textarea></div> 
...
<a href="formulario_cd_elab.php"><h4 class="text-primary">VOLVER A DATOS BÁSICOS</h4></a>
...
<a href="formulario_cd_pc.php"><h4 class="text-primary">CONTINUAR</h4></a>
