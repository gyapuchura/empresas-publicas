...
<div class="col-md-6"><h3><a href="mostrar_eval_cd_previa.php">VOLVER</a></h3></div>
</div>

<div class="box-area">
<div class="row">
<div class="col-md-12"><h2 class="text-success">II. EVALUACIÓN DE ACTIVIDADES PREVIAS</h2></div>
</div>
<?php
...
$numero=1;
    ...
    $sql4.=" WHERE registro_cd.idpunto_cd=punto_cd.idpunto_cd AND registro_cd.idcumplimiento=cumplimiento.idcumplimiento AND registro_cd.idformulario_cd='$idformulario_cd_ss' AND registro_cd.idetapa_cd='1' ";
...
<div class="row">
  ...
  <div class="col-md-2"><h5 class="text-success">FECHA DEL DOCUMENTO: </h5><h5 class="text-muted"><?php echo $row5[4];?></h5></div>
...
<form name="VERIFICA" action="guardar_verif_cd_reg.php" method="post">
...
<div class="row">
<div class="col-md-3"><h4><a href="mostrar_eval_cd_previa.php">VOLVER</a></h4></div>
<div class="col-md-6"></div>
<div class="col-md-3"><h4><a href="evalua_puntos_cd_pc.php">EVALUAR SIGUIENTE</a></h4></div>
</div>
</div>
</div>
</div>
