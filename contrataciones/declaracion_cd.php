...
<script language="javascript" src="../js/jquery-3.1.1.min.js"></script>
	...
	<div class="container">
      ...
      <h3 class="text-muted"><?php echo $row_e[1];?></h3>
      <h3 class="text-muted">MES: <?php echo $mes_ss;?></h3>
    </div>
    </div>
    <div class="row">
        <form name="FORMU" action="nuevo_formulario_cd.php" method="post">
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
        ...
        <td><?php echo $row[5];?></td>
            ...
            <?php if ($row[15] == "") {
              ?>
            <form name="VALIDA" action="valida_formulario_cd.php" method="post">
            <input name="idformulario_cd" type="hidden" value="<?php echo $row[0];?>">
            <input name="codigo_form" type="hidden" value="<?php echo $row[4];?>">
            <button type="submit" class="btn-link">ELABORAR</button></form>              
              <?php
              } else { echo "F-3009 FINALIZADO";}
              ?>                                    
            </td>
            </tr>  
        <?php
