...
<div class="col-md-6"><h2 class="text-danger">EL N° DE CUCE INTRODUCIDO PARA LA PRESENTE GESTIÓN <?php echo $gestion; ?></h2></div>
<div class="col-md-3"></div>
</div>
<div class="row">
<div class="col-md-3"> </div>
<div class="col-md-6"><h2 class="text-danger">YA FUE REGISTRADO EN SISTEMA.</h2></div>
<div class="col-md-3"> </div>
</div>
<div class="row">
<div class="col-md-3"></div>
<div class="col-md-6"><h4 class="text-warning">	  
<form name="VOLVER" action="nuevo_formulario_cd.php" method="post">	  
<button type="submit" class="btn-link">IR A NUEVO FORMULARIO</button>
</form></h4></div>
<div class="col-md-3"></div>
</div>
