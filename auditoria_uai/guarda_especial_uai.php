...
if ($codigo =='' || $gestion =='' || $idempresa =='' || $tipo_informe =='') {
    ...
    if (move_uploaded_file($_FILES['file']['tmp_name'],'../'.$subir_archivo)) {
        ...
        $ins = $link->query(" INSERT INTO uai_trabajo ( codigo, gestion, idempresa, tipo_informe, idtipo_hojaruta, elaborador, idusuario, url ) VALUES ( '$codigo','$gestion','$idempresa','$tipo_informe','28','$elaborador','$idusuario_ss','$subir_archivo') "); 
