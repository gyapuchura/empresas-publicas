...
if ($codigo =='' || $gestion =='' || $idempresa =='' || $tipo_informe =='') {
    ...
    header("Location:nueva_confiabilidad_uai.php"); 
    ...
    if ($file_name != '' || $file_name != null) {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'],'../'.$subir_archivo)) {
            ...
            $ins = $link->query(" INSERT INTO uai_trabajo ( codigo, gestion, idempresa, tipo_informe, idtipo_hojaruta, elaborador, idusuario, url ) VALUES ( '$codigo','$gestion','$idempresa','$tipo_informe','1','$elaborador','$idusuario_ss','$subir_archivo') "); 

                header("Location:confiabilidad_uai.php");
        ...
        {
            header("Location:otra_confiabilidad_uai.php"); 
        }  
}
?>