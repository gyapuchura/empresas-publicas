...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">AUDITORÍAS DE CONFIABILIDAD - UAI</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
      ...
      <h3 align="center"> </h3>
       <p>EN ESTA SECCIÓN SE ENCUENTRAN LOS REGISTROS DE LAS AUDITORIAS DE CONFIABILIDAD DE ESTADOS FINANCIEROS EVALUADOS A LAS UAIs.</p>
    </div>
    </div>
    <div class="row">
    <div class="col-md-4">
        <form name="FORMU" action="nueva_confiabilidad_uai.php" method="post">
        <button type="submit" class="btn btn-primary">NUEVO REGISTRO</button>
        </form>
    </div>
    <div class="col-md-4"></div>
    <div class="col-md-4">
    <h4><a href="../estadisticas/confiabilidad_empresas.php" target="_blank" onClick="window.open(this.href, this.target, 'width=1000,height=700,scrollbars=YES'); return false;">
    GRAFICO CONFIABILIDAD UAIS-EMPRESAS</a></h4>
    </div>
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            $sql.=" AND uai_trabajo.idtipo_hojaruta=tipo_hojaruta.idtipo_hojaruta AND uai_trabajo.idtipo_hojaruta='1' ORDER BY uai_trabajo.iduai_trabajo ";
            ...
            ?>
               ...
               <?php  if ($row[8] != '') { echo " VER INFORME "; } else { } ?>
                ...
                <a class="btn-link" target="_black" href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/empresas-publicas/'.$row[8]; ?>" >
        ...
        <!-- Modal ver el archivo -->
            ...
            <td>
                <form name="VALIDA" action="valida_confiabilidad_uai.php" method="post">
