...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <h2 class="pageTitle">REGISTRO DE CONFIABILIDAD UAI - <?php echo $row_c[1];?></h2>
    </div>
  </div>
</div>
</section>
...
<!-- javascript --->
<form name="FORM9" action="guarda_confiabilidad_uai_mod.php" method="post" enctype="multipart/form-data">
