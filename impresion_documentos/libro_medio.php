...
<?php
    ...
    ?>
<p><img src="../img/works/fondo_hoja_ruta.jpg" width="840" height="440" alt=""/></p>
  ...
  <tbody>
    <tr>
      <td width="225"><p>&nbsp;</p>
        ...
        <p style="text-align: center"><h3 style="text-align: center">HR: <?php echo $row_h[6];?><span style="text-align: center"></span></h3></p>
        <p>&nbsp;</p>
      <p>&nbsp;</p></td>
