...
$sql1 = " SELECT idcorres, gestion, correlativo, idusuario, referencia, procedencia, no_control, fecha_corres, ";
$sql1.= " anexo, codigo, comentario_conclusion, comentario_archivo, idestado FROM corres WHERE idcorres='$idcorres_ss' ";
...
?></td>
  ...
  <tr>
    <td colspan="3" style="font-size: 12px"><?php 
    if ($row1[12] == '3') {
      echo "COMENTARIO DE CONCLUSIÓN: </br>".$row1[10];
    } else {    
    }
    ?></td>
  </tr>
  <tr>
    <td colspan="3" style="font-size: 12px"><?php 
    if ($row1[12] == '4') {
      echo "COMENTARIO DE CONCLUSIÓN: </br> ".$row1[10]."</br></br>";
      echo "ESPECIFICACIÓN DE ARCHIVO: </br>".$row1[11];
    } else {    
    }
    ?></td>
  </tr>
