...
<div class="row">
<div class="col-lg-12">
<h3>FORMULARIOS DE ARCHIVO POR EMPRESA PÚBLICA</h3>
</div>
</div>
<!--- gestion de usuarios ---->
...
<div class="table-responsive">
    ...
    ?>
            ...
            <?php echo $row4[0];?> <?php echo $row4[1];?> <?php echo $row4[2];?> </br><?php echo $row4[3];?></td>
						<td>
            <a href="../impresion_documentos/imprime_formulario_arch.php?idform_archivo=<?php echo $row[0];?>&idusuario_arch=<?php echo $row[2];?>&codigo_form=<?php echo $row[4];?>&idempresa_form=<?php echo $row[5];?>" target="_blank" class="Estilo5" onClick="window.open(this.href, this.target, 'width=1100,height=800,scrollbars=YES,left=200'); return false;">IMPRIMIR FORMULARIO DE ARCHIVO</a>  
            </td>
						<td> 
            ...
            <input name="idempresa_form" type="hidden" value="<?php echo $row[5];?>">
